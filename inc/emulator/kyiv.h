...
struct Kyiv_t{
    ...
    QVector<QLineEdit*> drum1;
    QVector<QLineEdit*> drum2;
    QVector<QLineEdit*> drum3;
    ...
    bool execute_opcode(bool norm_work=true);

    void opcode_flow_control(const addr3_t& addr3_shifted, opcode_t opcode, const addr3_t &addr3, bool norm_work=true);

    void opcode_arythm(const addr3_t &addr3, opcode_t opcode, bool norm_work=true);
